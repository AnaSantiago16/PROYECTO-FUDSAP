...
private DefaultTableModel modeloOriginal;
    ...
    public Combos(Map<String, ProductoSeleccionado> carrito) {
...
//panelBotones.add(btn1);
    ...
    btn5.setBackground(new Color(139, 69, 19));
...
private void filtrarTabla(String texto) {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(tablaPersonas1);

        btn7.setText("jButton2");

        btn8.setText("jButton3");

        btn9.setText("jButton4");

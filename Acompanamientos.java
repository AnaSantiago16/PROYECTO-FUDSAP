 ...
 * @author Ana
 */
public class Acompanamientos extends javax.swing.JFrame {
...
private DefaultTableModel modeloOriginal;
    ...
    public Acompanamientos(Map<String, ProductoSeleccionado> carrito) {
...
//panelBotones.add(btn1);
    ...
    btn3.setBackground(new Color(139, 69, 19));
...
private void filtrarTabla(String texto) {
    DefaultTableModel filtrado = new DefaultTableModel(new Object[]{"Nombre", "Descripción", "Precio", ""}, 0) {
        @Override
        public boolean isCellEditable(int row, int column) {
            return column == 3;
        }
    ...
    for (int i = 0; i < modeloOriginal.getRowCount(); i++) {
        ...
        String descripcion = modeloOriginal.getValueAt(i, 1).toString().toLowerCase();

        if (nombre.contains(texto.toLowerCase()) || descripcion.contains(texto.toLowerCase())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Acompanamientos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Acompanamientos().setVisible(true);
            }
        });
    }
